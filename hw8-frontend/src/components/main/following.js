...
const Following = ({followings, dispatch, addFollowingMsg}) => {
    return (
        <div >
            ...
            <div>
                 <div className='Msg' id='addFollowingMsgId'>
                    {addFollowingMsg}
                </div>
...
export default connect(
    (state) => {
        //console.log(state.addFollowingMsg)
        return {
            addFollowingMsg : state.addFollowingMsg,
