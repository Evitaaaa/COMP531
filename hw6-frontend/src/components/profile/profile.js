                ...
                {keySet.map((key, index)=>{
                    if(titles.has(key)){
                        ...
                        <tr key={index} >
                                ...
                                <td className="show-info" id={key +'profile'}>{user[key]}</td>
    ...
    return(
        <div className='updateProfile content'>
            ...
            <form className='form-horizontal' onSubmit={(event) => {
                ...
                <div className='Msg' id='uptProfileMsgId'>
                    {uptProfileMsg}
                </div>
                ...
                <table align="center">
                   <h1>Update Profile</h1>
			        ...
			        <tr>
			            <td> Zipcode: </td>
			            <td><input type="text" placeholder="12345" id="zipcode" pattern="[0-9]{5}" 
			        ...
			        <tr>
			            <td> Password: </td>
			            <td><input type="password"  placeholder="Password" name="password" id="passwordId" 
			        ...
			        <tr>
			            ...
			            <td><input type="password"  placeholder="Repeat your password" name="cpassword" id="cpasswordId"
			                defaultValue={user.password2} className="input-info"
                             ref={(node)=>userProfile.password2 = node}/></td>

			        </tr>
                    <tr>
			            <td> <input type="submit" id="update" className="btn" value="Update"/> </td>
			        </tr>
                </table>
            </form>
        </div>
